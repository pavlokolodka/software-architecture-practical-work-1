namespace WinFormsApp1
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // distanceConverter1
            // 
            distanceConverter1.CentimetersDistance = 2.54D;
            distanceConverter1.CentimetersDistanceLabel = "Введіть сантиметри та натисніть Enter:";
            distanceConverter1.InchesDistance = 1D;
            distanceConverter1.InchesDistanceLabel = "Введіть дюйми та натисніть Enter:";
